...
{% include figure.html
filename='starbucks/feast.jpg'
caption='Bacon wrapped dates and artichoke flat bread: a typical late
night snack while closing.' %}
...
{% include figure.html
filename='starbucks/green.jpg'
caption='The green stuff, AKA "mean green"'%}
...
{% include figure.html
filename='starbucks/portrait.jpg'
caption="Perfection, isn't it?" %}
...
{% include figure.html filename='starbucks/mocha-party.jpg' %}

{% include figure.html filename='starbucks/mocha-party-2.jpg' %}
...
{% include figure.html
filename='starbucks/hiding.jpg'
caption='Hide and seek?' %}

{% include figure.html
filename='starbucks/yoga.png'
caption='I think we were inventing a new kind of yoga.' %}
