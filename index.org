...
* [[file:email-gnus-docker.org][Email with Gnus and Docker]]
:PROPERTIES:
:PUBDATE:  <2016-12-21 Wed>
:RSS_PERMALINK: email-gnus-docker.html
:END:

I moved my offlineimap/dovecot setup to a tidy docker container.  Gnus
is much happier now.
