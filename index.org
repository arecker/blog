...
some things.  Here are a few ways you can follow my blog by tracking
my [[file:feed/index.xml][rss feed]].
...
<a target="_blank" onclick="updateImage()"/>
  <img id="randomImage" style="cursor: pointer;" src="/images/loading.gif" alt="random" />
</a>
<br/>
<script>
